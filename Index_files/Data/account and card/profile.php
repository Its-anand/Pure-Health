...
<body onload="loader()">
    ...
    <div id="header_holder">
     ...
     <form style="cursor: pointer;" method="post" action="../../Data/account and card/logout.php">
        ...
        <form target="_blank" action="./card.php" method="post"><button value="submit" id="submit_btn" class="form_btn">Cards</button></form>
        <form target="_blank" action="./orderlist.php" method="post"><button value="submit" id="submit_btn" class="form_btn">Orders</button></form>
        <form target="_blank" action="./ordered_product.php" method="post"><button value="submit" id="submit_btn" class="form_btn">Delivered Products</button></form>
        <form target="_blank" action="./refund.php" method="post"><button value="submit" id="submit_btn" class="form_btn">Refund Request</button></form>
        <form target="_blank" action="./refund%20list.php" method="post"><button value="submit" id="submit_btn" class="form_btn">Refund Successful</button></form>
