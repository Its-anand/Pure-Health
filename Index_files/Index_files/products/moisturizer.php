...
$selectquery = "select * from products where id = 4 ";
...
<div id="right_div">
    ...
    <div id="description">
        <ul>
            <li>It provides UV protection and and can be used as a day cream or night cream.</li>
            <li>It helps to reduced dark spots.</li>
            <li>It give refreshing feel and help the skin to stay hydrated all day long.</li>
            <li>It provide optimum moisture to skin.</li>
            <li>Act as natural toner to skin and help to give soft, smooth and nourished skin.</li>
        </ul>
    </div>
</div>
</div>
    ...
    <script>
       document.getElementById("price_value4").innerHTML=localStorage.getItem("OZiva_Protein_Powder");
    </script>
</body>
</html>