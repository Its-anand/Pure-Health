        ...
        <th>
            <form action='delivered.php' method = 'POST'>
                <input type='hidden' name='order_id' value='<?php echo $res['order_id']?>'>
                 <input type='submit' name='submit' value='Delivered' style='border: none;background: #38ff38;height: 2rem; width: 8rem; font-size: 1.1rem; cursor: pointer; '>
            </form>
        </th>
